...
- 知识付费账号不能只讲“认知升级”。用户买课表面上是为了知识，本质上往往是为了“成为”：成为会用 AI 提效的人、能接项目的人、能被老板认可的人、能摆脱原来困境的人。
...
初始化结束后，AI 必须告诉用户后续怎么继续用：

- 总入口是 `MrCarlsama短视频获客全链路诊断私教`
- 用户不用记多个入口，把问题丢给总入口即可
- 总入口会判断当前问题属于初始化、单条内容诊断、选题库建设、案例素材、复盘、疑难杂症，还是私域承接
- 初始化完成后，通常先进入“精准选题库建设”或“单条内容诊断”
